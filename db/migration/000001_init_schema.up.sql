...
ALTER TABLE
    "entries" ADD CONSTRAINT "entries_account_id_foreign" FOREIGN KEY("account_id") REFERENCES "account"("id");
ALTER TABLE
    "transfers" ADD CONSTRAINT "transfers_from_account_id_foreign" FOREIGN KEY("from_account_id") REFERENCES "account"("id");
ALTER TABLE
    "transfers" ADD CONSTRAINT "transfers_to_account_id_foreign" FOREIGN KEY("to_account_id") REFERENCES "account"("id");